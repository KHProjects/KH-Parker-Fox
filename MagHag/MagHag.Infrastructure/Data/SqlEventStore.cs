...
namespace MagHag.Infrastructure.Data
{
    public sealed class SqlEventStore : IEventStore
    {
        ...
        private long InsertEventsAndReturnLastVersion(Guid streamId, SqlCeConnection connection, long nextVersion,
        ...
        private void StartNewSequence(Guid streamId, long nextVersion, SqlCeConnection connection)
        {
            const string commandText =
        ...
        private void UpdateSequence(Guid streamId, long expectedInitialVersion, long nextVersion, SqlCeConnection connection)
        {
            const string commandText =
